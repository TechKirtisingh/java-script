...
/////@@@@ vi)  slice(isme kewal index value hi print ) and splice(original me us index ki value nikal dete hai(change) aur last index bhi print hoga) me diiferece 
...
//push(New elements to add to the array.Appends new elements to the end of an array, and returns the " new length" of the array.)
...
///@@@@@ ix)  spread {symbol ...____, ..._____ ,..._____} (bikhar jayega) (act as a concat)(diff is we add infite no. of array)
